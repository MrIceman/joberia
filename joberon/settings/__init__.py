"""
Django settings for joberon project.
...
ALLOWED_HOSTS = ['159.69.187.0', 'localhost', '127.0.0.1', '.joberon.com']
...
WSGI_APPLICATION = 'joberon.wsgi.application'
